...
if (noCdn == true) {
	...
	var bioses = {"a5200": {path: "./RetroPieBIOS/BIOS/", files: ["5200.rom"]}, "atari800": {path: "./RetroPieBIOS/BIOS/", files: ["5200.rom"]}, "freechaf": {path: "./RetroPieBIOS/BIOS/", files: ["sl31253.bin", "sl31254.bin", "sl90025.bin"]}, "freeintv": {path: "./RetroPieBIOS/BIOS/", files: ["exec.bin", "grom.bin"]}, "gearcoleco": {path: "./RetroPieBIOS/BIOS/", files: ["colecovision.rom"]}, "handy": {path: "./RetroPieBIOS/BIOS/", files: ["lynxboot.img"]}, "mednafen_psx": {path: "./RetroPieBIOS/BIOS/", files: ["scph5500.bin", "scph5501.bin", "scph5502.bin"]}, "mednafen_psx_hw": {path: "./RetroPieBIOS/BIOS/", files: ["scph5500.bin", "scph5501.bin", "scph5502.bin"]}, "neocd": {path: "./RetroPieBIOS/BIOS/neocd/", files: ["neocd_z.rom"]}, "o2em": {path: "./RetroPieBIOS/BIOS/", files: ["c52.bin", "g7400.bin", "jopac.bin", "o2rom.bin"]}, "opera": {path: "./RetroPieBIOS/BIOS/", files: ["panafz10-norsa.bin", "panafz10ja-anvil-kanji.bin"]}, "px68k": {path: "./RetroPieBIOS/BIOS/keropi/", files: ["cgrom.dat", "iplrom.dat", "iplrom30.dat", "iplromco.dat", "iplromxv.dat"]}, "yabasanshiro": {path: "./RetroPieBIOS/BIOS/", files: ["saturn_bios.bin"]}, "yabause": {path: "./RetroPieBIOS/BIOS/", files: ["saturn_bios.bin"]}};
